            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12 col-md-12 col-lg-4 bg-transparent">
                        ...
                        <div className="card bg-transparent border border-0" style={{ width: "18rem" }}>
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-8 email-box ps-lg-5">
                        <p className="text-secondary text-start mt-md-1 stylishFont">To know our lattest update, sign up here ...</p>
